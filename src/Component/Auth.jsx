  ...
  <div className="col-6">
   <div className="signup">
    ...
    <div className="Social">
     <Link className="ic" to="#" onClick={FacebookLog}><i className="fab sc-ic fa-facebook"></i></Link>
     <Link className="ic" to="#" onClick={GoogleLog}><i className="fab sc-ic fa-google"></i></Link>
     <Link className="ic" to="#" onClick={TwitterLog}><i className="fab sc-ic fa-twitter"></i></Link>
    </div>
...
<div className="w-100" onClick={Toggler}><span><Link to="#" className="text-decoration-none text-danger">Already Have Account?</Link></span></div>
...
<div className="w-100"><span><Link to="/passreset" className="text-decoration-none text-danger my-2">Forget Your Password?</Link></span></div>
<div className=" line-container my-2"><div className="fw bg-dark text-light p-2">OR</div><hr/></div>
<div className="w-100" onClick={Toggler}><span><Link to="#" className="text-decoration-none text-danger my-2">Or Create Account</Link></span></div>
